...
class Matrix{
    public:
        ...
        Matrix operator+(const int value) const; //Addition scalar
        Matrix operator-(const Matrix &mat2) const; //Subtraction
        Matrix operator-(const int value) const; //Subtraction scalar
        Matrix operator*(const Matrix &mat2) const; //Multiplication
        Matrix operator*(const int value) const; //Multiplication scalar
        Matrix operator/(const int value) const; //Division scalar
